...
namespace Confluent.Kafka.DependencyInjection.Statistics
{
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://github.com/edenhill/librdkafka/blob/master/STATISTICS.md#partitions">librdkafka documentation</see> for more information.
    /// </remarks>
    public class PartitionStatistics
    {
        ...
        /// <summary>
        /// Difference between (HighOffset or LastStableOffset) - max(AppOffset, CommittedOffset). HighOffset is used when isolation.level=read_uncommitted, otherwise LastStableOffset.
        /// </summary>
